...
class WebhookClient:
    ...
    def __init__(self, lottery_url: str, lottery_token: str, power_automate_url: Optional[str] = None):
    ...
    async def send_to_lottery_system(self, payload: LotteryWebhookPayload) -> Dict[str, Any]:
        """发送数据到抽奖系统"""
        try:
            headers = {
    ...
    async def send_to_power_automate(self, payload: PowerAutomatePayload) -> Dict[str, Any]:
        """发送数据到Power Automate"""
